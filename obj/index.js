...
let allEvents = [
    {"id":0,"i-index": -1,"z-index":0,"title":"Сараево","name":"Убийство, запустившее мировой конфликт","description":"Атентат на эрцгерцога Франца Фердинанда в Сараево, который стал прямым поводом к началу войны.","imglink":"1.webp","references":[null],"x":-1,"y":-1,"r":-1,"ac":-1},
    ...
    {"id":2,"i-index": -1,"z-index":1,"title":"Марне","name":"Марне: Переломный момент","description":"Первая битва на Марне останавливает немецкое наступление и заставляет их отступить.","imglink":"3.jpg","references":[1],"x":-1,"y":-1,"r":-1,"ac":-1},
    {"id":3,"i-index": -1,"z-index":2,"title":"Галицийская битва","name":"Восточный фронт в огне","description":"Русские войска одерживают победу над австро-венгерскими войсками, освобождая Галицию.","imglink":"4.webp","references":[1,2],"x":-1,"y":-1,"r":-1,"ac":-1},
    {"id":4,"i-index": -1,"z-index":2,"title":"Хлор","name":"Новая эра ведения войны","description":"Впервые использование газа в качестве оружия, что привело к массовым жертвам.","imglink":"5.jpg","references":[2,3],"x":-1,"y":-1,"r":-1,"ac":-1},
    ...
    {"id":6,"i-index": -1,"z-index":3,"title":"Верден","name":"Верден: Изнурительная битва","description":"Одна из самых длительных и кровопролитных битв войны.","imglink":"7.webp","references":[4,5],"x":-1,"y":-1,"r":-1,"ac":-1},
    {"id":7,"i-index": -1,"z-index":3,"title":"Революция","name":"Конец империи, начало новой эры","description":"Свержение монархии и начало пути к большевистской власти.","imglink":"8.webp","references":[6,7],"x":-1,"y":-1,"r":-1,"ac":-1},
    {"id":8,"i-index": -1,"z-index":4,"title":"США","name":"Вступление США в войну","description":"Вступление США в войну приносит новые ресурсы и силы союзникам.","imglink":"9.webp","references":[6,7],"x":-1,"y":-1,"r":-1,"ac":-1},
    {"id":9,"i-index": -1,"z-index":5,"title":"Компьен","name":"Конец войны, начало мира","description":"Подписание перемирия, положившего конец боевым действиям.","imglink":"10.webp","references":[7,8],"x":-1,"y":-1,"r":-1,"ac":-1}
    ];
